defmodule Spreedly.Environment do
  ...
  You can pattern match on the response.
      ...
      iex> case Spreedly.Environment.purchase(env, "R8AKGmYwkZrrj2BpWcPge", "RjTFFZQp4MrH2HJNfPwK", 2344) do
              {:ok, %{succeeded: true}} ->
                IO.puts "Success!"
  ...
  ### Show a Transaction
      ...
      iex> Spreedly.Environment.show_transaction(env, "7f6837d1d22e049f8a47a8cc1fa9")
      {:ok,
  ...
  """
  @spec purchase(t, String.t, String.t, pos_integer, String.t, Keyword.t) :: {:ok, any} | {:error, any}
  ...
  """
  @spec authorization(t, String.t, String.t, pos_integer, String.t, Keyword.t) :: {:ok, any} | {:error, any}
  ...
  """
  @spec verify(t, String.t, String.t, String.t | nil, Keyword.t) :: {:ok, any} | {:error, any}
  ...
  """
  @spec list_payment_method_transactions(t, String.t, Keyword.t) :: {:ok, any} | {:error, any}
  ...
  """
  @spec list_gateway_transactions(t, String.t, Keyword.t) :: {:ok, any} | {:error, any}
